...
def load_vcf_file(filename):
    ...
    for vcf_record in vcf_records:
        ...
        Annotation can be obtaining by checking if the variant has synonymous codons? To get the codon, I think it is enough the gff file (so that you know the CDS and the ORF), and the genome, to check if the variation induces a synonimous codon or not
